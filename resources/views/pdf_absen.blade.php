    ...
    <div class="container-fluid" style="margin-left: 40dp; margin-right: 40dp;">
        <table width='100%' class="mt-5 ">
            ...
            <tr class="text-center">
                ...
                @for($i = 0; $i < 5; $i++) <td style="border: 1px solid black;">{{ $absensiUser[$index]['masuk'][$i] != null ? '✔️': '❌'}}</td>
                    <td style="border: 1px solid black;">{{ $absensiUser[$index]['siang1'][$i] != null ? '✔️': '❌'}}</td>
                    <td style="border: 1px solid black;">{{ $absensiUser[$index]['siang2'][$i] != null ? '✔️': '❌'}}</td>
                    <td style="border: 1px solid black;">{{ $absensiUser[$index]['pulang'][$i] != null ? '✔️': '❌'}}</td>
                    @endfor
