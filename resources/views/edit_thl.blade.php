...
<div class="card">
    <div class="card-header">
        <h4 class="card-title">Edit THL</h4>
    </div>

    <div class="card-body">
        <form action="/edit-user/{{ $user->id }}/update" method="post">
            <div class="row">
                @csrf
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    ...
                    <div class="d-flex flex-row justify-content-between">
                        <a href="/edit-pass-user/{{$user->id}}" class="btn icon icon-left btn-warning"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check-circle">
